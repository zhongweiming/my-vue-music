<template>
  <transition name="list-fade">
    <div class="playlist" ref="playlist" v-show="showFlag" @click="hide">
...
<!--              不阻止冒泡会触发上面的 selectItem 造成一系列问题，我去！！！终于找到问题了-->
      ...
      <confirm ref="confirm" text="是否清空播放列表" confirmText="清空" @confirm="confirmClear"></confirm>
...
export default {
  ...
  methods: {
    ...
    deleteOne (item) {
      ...
      // 如果播放列表清空了，那么手动隐藏这个播放列表，不然等再点击一首歌的时候这个播放列表会一同弹出来。
